...
/*
 * This is used to add data read from Yelp Dataset and store it in the JSON.
 */
...
public class PopulatingDatabase {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		PopulatingDatabase dc = new PopulatingDatabase();

		dc.loadDataToMongoDB("C:\\Users\\kaust\\Downloads\\yelp-dataset\\yelp_academic_dataset_business.json", "business");
		dc.loadDataToMongoDB("C:\\Users\\kaust\\Downloads\\yelp-dataset\\yelp_academic_dataset_review.json", "reviews");		
		dc.loadDataToMongoDB("C:\\Users\\kaust\\Downloads\\yelp-dataset\\yelp_academic_dataset_user.json", "users");
		dc.loadDataToMongoDB("C:\\Users\\kaust\\Downloads\\yelp-dataset\\yelp_academic_dataset_review.json", "training_review");
		dc.loadDataToMongoDB("C:\\Users\\kaust\\Downloads\\yelp-dataset\\yelp_academic_dataset_review.json", "testing_review");
	}

	public void loadDataToMongoDB(String fileP, String collectionName) throws IOException, ParseException {
		MongoClient mc = new MongoClient("localhost", 27017);
		MongoDatabase database = mc.getDatabase("YelpDatasetPhoenix");
